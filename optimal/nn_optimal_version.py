...
# Optimal Version with regularization and increased network size
import os
import pandas as pd
import numpy as np
import torch
...
class GenreClassifier(nn.Module):
    def __init__(self, input_size, hidden_size=128, num_classes=10, dropout_p=0.2):
        super().__init__()
        self.net = nn.Sequential(
            nn.Linear(input_size, hidden_size),
            nn.ReLU(),
            nn.Dropout(dropout_p),         # keep light regularization
