...
# Version that uses weighted loss to address class imbalance
import os
import pandas as pd
import numpy as np
import torch
...
# This creates a weight for each class (0-10)
...
# Tell the loss function to use these weights
criterion = nn.CrossEntropyLoss(weight=weights_tensor)
print("Using weighted loss to combat class imbalance.")
